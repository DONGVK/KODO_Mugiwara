...
<script type="text/javascript">
          ...
          function validation(f) {
            if (f.mdp1.value != f.mdp.value) {
              ...
              alert('Les adresses mails ne sont pas identiques !');
              f.mail.focus();
              change_onglet('etape2');
              return false;
            }
...
<center>
  ...
  <form method="POST" action="\inscription">
    @csrf
    {{ csrf_field() }}
  <div id="contenu_onglet_etape1" class="contenu_onglet" onSubmit="return validation(this)">
      <input type="radio" name="statue" value="4" checked style="display:none"> Organisateur
      <br/>
